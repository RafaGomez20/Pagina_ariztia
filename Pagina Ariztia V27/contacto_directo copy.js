let sessionPage = sessionStorage.getItem("rol");

if(sessionPage === 'ADMIN'){
  //si es admin hace o muestra esto
} else {
  //si no es admin hace o muestra esto
}
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const filtroMes = document.getElementById("filtro-mes"); // Ahora el ID correcto es filtro-mes
  const filtroDia = document.getElementById("filtro-dia"); // Ya existe en el HTML
